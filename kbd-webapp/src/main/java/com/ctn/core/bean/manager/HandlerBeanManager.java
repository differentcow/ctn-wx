package com.ctn.core.bean.manager;
 ...
 */
@Component
public class HandlerBeanManager {
    ...
    public void init() {
        ...
        try {
            ...
            properties.load(this.getClass().getResourceAsStream("/cbd.properties"));
            String classPath = properties.getProperty("handler.class.path","com.ctn.*");
            ...
            for (Class c : classSet){
                ...
                for(Method m : ms){
                    if (m.isAnnotationPresent(Handler.class)){
                        Handler handler = m.getAnnotation(Handler.class);  //获取Handler Annotation对象
                        if(o == null){
                            o = c.newInstance();
                        }
                        handlerMapping.add(handler.type(),handler.value(), m.getName(), o);
                    }
                }
            }
